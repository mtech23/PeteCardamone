            ...
            <div class="row">
                <div class="col-sm-12 col-lg-5 mx-auto">
                   ...
                   <div class="main_login_form">
                        ...
                        <h6 class="text-center">WELCOME! SIGNUP TO CONTINUE</h6>
                        ...
                        <form action="">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label for="login_form_confirm_password" class="password_label">Confirm Password</label>
                                <div class="password_with_icon">
                                    <span class="lock_icon"><i class="fa-solid fa-lock"></i></span>
                                    <input type="password" class="form-control form_password_field" id="login_form_confirm_password" placeholder="Re-Enter Your Password">
                                </div>
                              </div>
                              ...
                              <div class="text-center mt-2">
                                <span class="register_btn">Already have an Account? <a href="./loginpage.php">Login</a></span>
                              </div>
                              ...
                              <!-- <div class="text-center mt-2">
                                <span class="register_btn">Don't have an Account? <a href="javascript:;">Register</a></span>
                              </div> -->
